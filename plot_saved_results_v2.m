...
chk = isfield(results,'runningmedianbeta');
if (chk==1)
    runningmedianbeta = results.runningmedianbeta;
    runningmedianZ = results.runningmedianZ;
    runningmedianpois = results.runningmedianpois;
else 
    runningmedianbeta = results.runningmeanbeta;
    runningmedianZ = results.runningmeanZ;
    runningmedianpois = results.runningmeanpois;
end
