...
%to set up inversion edit lines 14-15, 22-53, 128-208
...
addpath('location-of-crewes-zoeppritz');%add path of CREWES zoeppritz function
...
BED = 'STIFF'; %choose bed, can use various synthetics or set BED = 'REAL' for real data
...
%SSdatafile = 'FILENAME-FOR-REAL-SS-DATA.mat'; %optional
